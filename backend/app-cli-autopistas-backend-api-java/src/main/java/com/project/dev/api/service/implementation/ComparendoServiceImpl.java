/*
 * @overview        {ComparendoServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code ComparendoServiceImpl}.
 *
 * @author Dyson Parra
...
public class ComparendoServiceImpl implements GenericService<ComparendoDTO> {
    ...
    public Page<ComparendoDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Comparendo con paginación");
    ...
    public ComparendoDTO saveUpdate(ComparendoDTO entityDTO) throws Exception {
        ...
        ComparendoDTO dto = entityMapping.getDto(entity);
        return dto;
    }
