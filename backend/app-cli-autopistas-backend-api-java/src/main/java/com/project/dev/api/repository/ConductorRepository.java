...
/**
 * TODO: Description of {@code ConductorRepository}.
 *
 * @author Dyson Parra
...
public interface ConductorRepository extends JpaRepository<Conductor, Long> {
    ...
    @Query("SELECT m FROM Conductor m WHERE m.intCedulaConductor LIKE CONCAT('%', :strSearch, '%')")
