...
/**
 * TODO: Description of {@code ConductorRestAssembler}.
 *
 * @author Dyson Parra
 * @since 11
 */
...
public class ConductorRestAssembler implements RepresentationModelAssembler<ConductorDTO, EntityModel<ConductorDTO>> {
    ...
    public EntityModel<ConductorDTO> toModel(ConductorDTO entityDTO) {
        return new EntityModel<>(entityDTO,
                WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(ConductorRest.class).getEntity(String.valueOf(entityDTO.getIntCedulaConductor()))).withSelfRel(),
