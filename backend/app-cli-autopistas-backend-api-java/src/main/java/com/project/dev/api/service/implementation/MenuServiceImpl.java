...
import com.project.dev.api.repository.MenuRepository;
import com.project.dev.api.service.GenericService;
import com.project.dev.api.service.exception.EntityNotFoundException;
import com.project.dev.api.service.mapping.MenuMapping;
...
/**
 * TODO: Description of {@code MenuServiceImpl}.
 *
 * @author Dyson Parra
...
public class MenuServiceImpl implements GenericService<MenuDTO> {

    private final Logger log = LoggerFactory.getLogger(MenuServiceImpl.class);
    private final MenuRepository entityRepository;
    private final MenuMapping entityMapping = Mappers.getMapper(MenuMapping.class);
     ...
     */
    public MenuServiceImpl(MenuRepository entityRepository) {
    ...
    public Page<MenuDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Menu con paginación");
     ...
     */
    @Override
    public MenuDTO saveUpdate(MenuDTO entityDTO) throws Exception {
        log.debug("Solicitud para guardar la entidad tipo Menu: {}", entityDTO);

        //TODO: agregar validación específica del servicio.
        Menu entity = entityMapping.getEntity(entityDTO);
        entity = entityRepository.save(entity);

        MenuDTO dto = entityMapping.getDto(entity);
        return dto;
    }
     ...
     */
    @Override
    public MenuDTO getEntity(String id) throws Exception {
    ...
    public void deleteEntity(String id) throws Exception {
        log.debug("Solicitud para eliminar la entidad tipo Menu: {}", id);
