...
/**
 * TODO: Description of {@code MenuRepository}.
 *
 * @author Dyson Parra
...
public interface MenuRepository extends JpaRepository<Menu, String> {
    ...
    @Query("SELECT m FROM Menu m WHERE m.strId LIKE CONCAT('%', :strSearch, '%')")
    public List<Menu> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Menu m WHERE m.strId LIKE CONCAT('%', :strSearch, '%')")
    public Page<Menu> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
