...
/**
 * TODO: Description of {@code ConfiguracionRestAssembler}.
 *
 * @author Dyson Parra
...
public class ConfiguracionRestAssembler implements RepresentationModelAssembler<ConfiguracionDTO, EntityModel<ConfiguracionDTO>> {
    ...
    public EntityModel<ConfiguracionDTO> toModel(ConfiguracionDTO entityDTO) {
        return new EntityModel<>(entityDTO,
                WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(ConfiguracionRest.class).getEntity(String.valueOf(entityDTO.getIntIdConfiguracion()))).withSelfRel(),
