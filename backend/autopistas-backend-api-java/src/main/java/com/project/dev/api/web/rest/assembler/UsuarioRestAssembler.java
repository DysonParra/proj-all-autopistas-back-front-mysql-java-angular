/*
 * @fileoverview    {UsuarioRestAssembler} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
public class UsuarioRestAssembler implements RepresentationModelAssembler<UsuarioDTO, EntityModel<UsuarioDTO>> {
    ...
    public EntityModel<UsuarioDTO> toModel(UsuarioDTO entityDTO) {
        return new EntityModel<>(entityDTO,
                WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(UsuarioRest.class).getEntity(String.valueOf(entityDTO.getIntCedulaUsuario()))).withSelfRel(),
