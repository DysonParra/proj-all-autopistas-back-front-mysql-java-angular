/*
 * @fileoverview    {TransitoDinamicaServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code TransitoDinamicaServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class TransitoDinamicaServiceImpl implements TransitoDinamicaService {
    ...
    public Page<TransitoDinamicaDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo TransitoDinamica con paginacion");
    ...
    public TransitoDinamicaDTO saveUpdate(TransitoDinamicaDTO entityDTO) throws Exception {
        ...
        TransitoDinamicaDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
