/*
 * @fileoverview    {ConductorServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
import com.project.dev.api.service.ConductorService;
...
/**
 * TODO: Definición de {@code ConductorServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class ConductorServiceImpl implements ConductorService {
    ...
    public ConductorDTO saveUpdate(ConductorDTO entityDTO) throws Exception {
        ...
        ConductorDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
