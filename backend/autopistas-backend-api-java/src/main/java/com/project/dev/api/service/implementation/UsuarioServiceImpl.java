/*
 * @fileoverview    {UsuarioServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code UsuarioServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class UsuarioServiceImpl implements UsuarioService {
    ...
    public Page<UsuarioDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Usuario con paginacion");
    ...
    public UsuarioDTO saveUpdate(UsuarioDTO entityDTO) throws Exception {
        ...
        UsuarioDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
