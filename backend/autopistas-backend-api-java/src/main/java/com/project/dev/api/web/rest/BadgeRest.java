...
/**
 * TODO: Definición de {@code BadgeRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class BadgeRest {
    ...
    private final BadgeService entityService;
     ...
     */
    public BadgeRest(BadgeService entityService,
    ...
    public ResponseEntity<List<BadgeDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/Badge/{query}/pages")
    public ResponseEntity<List<BadgeDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/Badge/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
