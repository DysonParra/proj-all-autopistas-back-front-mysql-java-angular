/*
 * @fileoverview    {CategoriaServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
import com.project.dev.api.service.CategoriaService;
...
/**
 * TODO: Definición de {@code CategoriaServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class CategoriaServiceImpl implements CategoriaService {
    ...
    public CategoriaDTO saveUpdate(CategoriaDTO entityDTO) throws Exception {
        ...
        CategoriaDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
    ...
    public CategoriaDTO getEntity(String id) throws Exception {
        ...
        Categoria searchedEntity = entityRepository.findById(Long.parseLong(id))
