/*
 * @fileoverview    {RegistroVehiculoServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code RegistroVehiculoServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class RegistroVehiculoServiceImpl implements RegistroVehiculoService {
    ...
    public RegistroVehiculoDTO saveUpdate(RegistroVehiculoDTO entityDTO) throws Exception {
        ...
        RegistroVehiculoDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
