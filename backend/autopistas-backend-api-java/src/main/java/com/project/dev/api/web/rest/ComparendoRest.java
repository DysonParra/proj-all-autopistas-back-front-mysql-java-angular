...
public class ComparendoRest {
    ...
    public ResponseEntity<List<ComparendoDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    public ResponseEntity<List<ComparendoDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
