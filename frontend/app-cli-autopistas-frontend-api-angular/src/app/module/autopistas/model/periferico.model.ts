...
/**
 * TODO: Description of {@code PerifericoViewModel}.
 *
 * @author Dyson Parra
...
export class PerifericoViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intId: number;
    public enmTipoPeriferico: string;
    public strIp: string;
    public intPuerto: number;
     ...
     *
     */
    public newEntity(): PerifericoViewModel {
        return new PerifericoViewModel();
    }
