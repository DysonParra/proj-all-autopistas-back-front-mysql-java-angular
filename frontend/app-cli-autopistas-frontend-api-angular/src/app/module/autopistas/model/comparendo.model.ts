...
/**
 * TODO: Description of {@code ComparendoViewModel}.
 *
 * @author Dyson Parra
...
export class ComparendoViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdComparendo: number;
    public strPlacaVehiculo: string;
    public intIdPolicia: number;
    public intCedulaConductor: number;
    public intTiqueteNro: number;
    public intCodigoComparendo: number;
    public strObservaciones: string;
    public enmTipoInfractor: string;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): ComparendoViewModel {
        return new ComparendoViewModel();
    }
