/*
 * @fileoverview    {MercanciaViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code MercanciaViewModel}.
 *
 * @author Dyson Parra
...
export class MercanciaViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdMercancia: number;
    public strNombreMercancia: string;
    public strDescripcionMercancia: string;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): MercanciaViewModel {
        return new MercanciaViewModel();
    }
