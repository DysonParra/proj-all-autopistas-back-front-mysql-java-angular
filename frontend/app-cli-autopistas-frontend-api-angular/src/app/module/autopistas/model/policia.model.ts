...
/**
 * TODO: Description of {@code PoliciaViewModel}.
 *
 * @author Dyson Parra
...
export class PoliciaViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdPolicia: number;
    public strNombrePolicia: string;
    public strApellidoPolicia: string;
     ...
     *
     */
    public newEntity(): PoliciaViewModel {
