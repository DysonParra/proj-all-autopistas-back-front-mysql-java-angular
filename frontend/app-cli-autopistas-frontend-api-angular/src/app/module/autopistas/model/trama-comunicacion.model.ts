/*
 * @fileoverview    {TramaComunicacionViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code TramaComunicacionViewModel}.
 *
 * @author Dyson Parra
...
export class TramaComunicacionViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdTrama: number;
    public strNombreTrama: string;
    public intPosicionInicial: number;
    public intTotalDatosPeso: number;
    public crCaracterFin: string;
    public crCaracterInicio: string;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): TramaComunicacionViewModel {
        return new TramaComunicacionViewModel();
    }
