...
/**
 * TODO: Description of {@code MenuViewModel}.
 *
 * @author Dyson Parra
...
export class MenuViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public strId: string;
    public strTitle: string;
    public strSubtitle: string;
    public strType: string;
    public strIcon: string;
    public strLink: string;
    public bitExactMatch: boolean;
    public bitActive: boolean;
    public bitDisabled: boolean;
    public strBadge: string;
    public strFather: string;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): MenuViewModel {
