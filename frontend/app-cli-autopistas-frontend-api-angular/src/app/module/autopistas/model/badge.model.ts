...
/**
 * TODO: Description of {@code BadgeViewModel}.
 *
 * @author Dyson Parra
...
export class BadgeViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public strTitle: string;
    public strClasses: string;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): BadgeViewModel {
